        ...
        <div>
          ...
          <div className="mt-9 flex flex-wrap items-center gap-4">
            <Magnetic className="hero-cta">
              <a
                href="#flagship"
                className="inline-block rounded-full bg-gradient-to-r from-cyan via-violet to-pink px-7 py-3.5 text-sm font-semibold text-bg hover:brightness-110 transition"
              >
                See the work
              </a>
            </Magnetic>
            <Magnetic className="hero-cta">
              <a
                href="#arcade"
                className="inline-block rounded-full border border-border px-7 py-3.5 text-sm font-semibold hover:border-cyan/60 transition"
              >
                Play a game
              </a>
            </Magnetic>
