...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "A marketplace connecting talented Bahraini students with people who need design, tutoring, photography, writing, and more — a soft, editorial visual language built to make student work feel credible.",
